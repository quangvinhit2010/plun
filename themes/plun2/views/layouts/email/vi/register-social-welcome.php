    	...
    	<table width="563" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:12px; color:#565656;">
          ...
          <tr style="height:305px;">
            <td style="border-top:2px solid #d7d7d7; background:#FFF; padding:20px;" align="left" valign="top">
            	<p style="font-size:14px; margin-bottom: 10px;">Chào <b><?php echo $username; ?></b>,</p>
            	
            	<p>Bạn đã đăng nhập thành công PLUN qua tài khoản <?php echo $social; ?> ( <?php echo $email; ?>). 
            		Vui lòng ghi nhớ chi tiết đăng nhập của bạn ở bên dưới. Bạn có thể thay đổi mật khẩu 
            		 <a href="<?php echo $changepass_url; ?>" target="_blank"> tại đây</a> 
            		để cho dễ nhớ nếu bạn thích.
            	</p>
            	<p>
	            	<strong>Chi tiết đăng nhập</strong> <br />
					Tên đăng nhập : <strong><?php echo $username; ?></strong><br />
					Mật khẩu: <strong><?php echo $password; ?></strong>
            	</p>
            	
                <p>
                	Lưu ý: Bạn vẫn có thể sử dụng tên đăng nhập "<?php echo $username; ?>" để đăng nhập vào PLUN hoặc đăng nhập 
                	bằng tài khoản <?php echo $social; ?>
                </p>
