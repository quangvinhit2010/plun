    	...
    	<table width="563" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:12px; color:#565656;">
          ...
          <tr style="height:205px;">
            <td style="border-top:2px solid #d7d7d7; background:#FFF; padding:20px;" align="left" valign="top">
            	<p style="font-size:14px;">Chào <b>Ryan vo</b></p>
                <p style="line-height:18px;"><b>Tahoma</b>  wants to be your friend on PLUN.Asia
Confirm his friend request to see his profile and photo. You also can give him some gift by using our Candy System.</p>
                    	...
                    	<table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td style="padding-right:10px;" align="left" valign="top">
                            	<p style="font-size:14px; margin-bottom:0; margin-top:0;"><b>Tahoma</b></p>
                            	<p style="margin-top:5px; margin-bottom:0;">Ho Chi Minh City, Viet Nam</p>
                                <p style="margin-top:5px; margin-bottom:0;"><b>Role:</b> Top</p>
                                <p style="margin-top:5px; margin-bottom:0;"><b>Height:</b> 174cm  -  <b>Weight:</b> 68kg</p>
                            </td>
                          </tr>
                        </table>
                    </td>
                  ...
                  <tr>
                    <td>
                    	<table border="0" cellspacing="0" cellpadding="0" style="margin-top:15px;">
                          <tr>
                            <td style="padding-right:10px;"><a href="#" style="background:#662e91; font-size:12px; text-transform:uppercase; color:#FFF; padding:4px 10px; text-decoration:none;">ADD HIM AS A FRIEND</a></td>
                ...
                <p>After all, is there any greater gift than friendship?</p>
                <p>Thanks</p>
				<p><b>PLUN.ASIA</b></p>
            </td>
          </tr>
