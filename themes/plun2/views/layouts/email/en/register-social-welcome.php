    	...
    	<table width="563" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:12px; color:#565656;">
          ...
          <tr style="height:305px;">
            <td style="border-top:2px solid #d7d7d7; background:#FFF; padding:20px;" align="left" valign="top">
            	...
            	<p>You have logged in successfully to PLUN via <?php echo $social; ?> ( <?php echo $email; ?>). 
            		Please remember detail your username. You can change password 
            		 <a href="<?php echo $changepass_url; ?>" target="_blank"> at here</a> 
            		if you like !
            	</p>
            	<p>
                ...
                <p>
                	Noted: You can use the account "<?php echo $username; ?>" or other account <?php echo $social; ?>  to log in to PLUN.
                </p>
