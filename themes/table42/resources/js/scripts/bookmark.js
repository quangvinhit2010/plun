var Bookmark = {
	...
	build_add_button: function(id){
		return '<a id="boookmark-icon" title="" href="javascript:void(0);" onclick="Bookmark.add_bm('+ id +');"></a>';
	},
	build_remove_button: function(id){
		return '<a id="boookmark-icon" title="" href="javascript:void(0);" onclick="Bookmark.delete_bm('+ id +');"></a>';
	},
	show_more: function(){
		objCommon.loading();
