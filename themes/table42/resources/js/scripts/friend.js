var Friend = {
	...
	unfriend_infriendlist: function(friend_id, alias){
	    ...
	    $.ajax({
	        ...
	        success: function(data) {
	        	objCommon.unloading();
	        	$('.friendlist-item-' + friend_id).fadeOut();
	        },
	        dataType: 'html'
	    });
	    return false; 
	...
	_build_addfriend_icon: function(friend_id, alias){
		return '<a title="Friend" href="javascript:void(0);" onclick="Friend.add_friend(\'' + friend_id + '\', \'' + alias + '\');"></a>';
	},
	_build_unfriend_icon: function(friend_id, alias){
		return '<a title="Friend" href="javascript:void(0);" onclick="Friend.confirm_unfriend(\'' + friend_id + '\', \'' + alias + '\');"></a>';
	},
	_build_cancelrequest_icon: function(friend_id, alias){
		return '<a title="Friend" href="javascript:void(0);" onclick="Friend.confirm_cancel_request(\'' + friend_id + '\', \'' + alias + '\');"></a>';
	},
	_build_decisionrequest_icon: function(friend_id, alias){
		return '<a title="Friend" href="javascript:void(0);" onclick="Friend.confirm_decision_request(\'' + friend_id + '\', \'' + alias + '\');"></a>';
	},		
	//cancel request
