    ...
    <div class="table42 clearfix"> 
    	<div class="list_request_page content">
        	<div class="wrap_user_req clearfix">
        		<h1>Danh sách gửi yêu cầu kết đôi</h1>
                <div class="wrap_img_person listrequest">
	                
                </div>
                <a href="javascript:void(0);" class="icon_table42 iconNextBack icon_back_list" onclick="Tablefortwo.getListrequestPre();"></a>
                <a href="javascript:void(0);" class="icon_table42 iconNextBack icon_next_list" onclick="Tablefortwo.getListrequestNext();"></a>
