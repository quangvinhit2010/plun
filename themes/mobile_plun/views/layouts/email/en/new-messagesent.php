    	...
    	<table width="563" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:12px; color:#565656;">
          ...
          <tr style="height:205px;">
            <td style="border-top:2px solid #d7d7d7; background:#FFF; padding:20px;" align="left" valign="top">
            	<p style="font-size:14px;">Dear <b><?php echo $to->getDisplayName();?></b></p>
                <?php if($messages):?>               
                    <?php foreach ($messages as $message):?>     
                        ...
                        ?>          
                        <p style="line-height:18px;"><b><?php echo $msgUser->getDisplayName();?></b> has send you a personal message entitled </b> “<?php echo Util::partString($displayMsg->message, 0, 100);?>” at <?php echo date('H:i A d/m/Y', $displayMsg->created);?>.</p>
                    <?php endforeach;?>
                <?php endif;?>
                <p style="margin-bottom:2px; margin-top:20px;">Click the link below to view or reply the message: </p>
