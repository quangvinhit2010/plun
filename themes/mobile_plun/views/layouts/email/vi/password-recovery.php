    	...
    	<table width="563" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:12px; color:#565656;">
          ...
          <tr style="height:205px;">
            <td style="border-top:2px solid #d7d7d7; background:#FFF; padding:20px;" align="left" valign="top">
                ...
                <p style="line-height:18px; margin-bottom:0;">Để thay đổi mật khẩu, vui lòng bấm vào đường dẫn phía dưới hoặc sao chép và dán vào thanh trình duyệt. Nếu không phải bạn yêu cầu thay đổi mật khẩu vui lòng bỏ qua tin nhắn này.</p>
