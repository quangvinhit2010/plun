...
<?php 
    ...
    $this->widget('mobile.widgets.UserPage.PopupAlert', array('class'=>'activation', 'content'=>$msg));
    
    $msg = Yii::app()->controller->renderPartial('//Notify/account-re-activation',array('user'=>$user, 'opt'=>2), true);
    $this->widget('mobile.widgets.UserPage.PopupAlert', array('class'=>'resend-activation', 'content'=>$msg));
?>
    <script type="text/javascript">
        jQuery('document').ready(function(){
