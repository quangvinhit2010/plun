...
$.fn.cycle.updateActivePagerLink = function(pager, currSlide) {
	$(pager).each(function() {
		...
		var attLink = $(this).find('a').filter('a:eq('+currSlide+')').attr('rel');
		$('#banner_slide .slide_link a').replaceWith( "<a href=" + attLink + ">&nbsp;</a>" )
	});
};
...
(function($) {
	...
	this.each(function() {
		...
		function autoHeight(t) {
			...
			$(o.container,obj).animate({height: getHeight+20},o.autoHeight);					
		};		
