    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(!data.search_global){
            	var findhim_str	=	tr('members in &1 &2 &3 matched your criteria', '<a title="" class="area" href="javascript:void(0);">', area, '</a>');
            }else{
            	var findhim_str	=	tr('members are online &1worldwide&2','<a title="" class="area" href="javascript:void(0);">', '</a>');
            }
