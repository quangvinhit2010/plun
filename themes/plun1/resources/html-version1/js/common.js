...
function close_Area_Reference(){
	...
	$(".main .col-right .members h3 .area").live('click', function(){
		$('.location-cont').show();
		$('.reference-cont').hide();	
		if(!$('.location-tab').parent().hasClass('active')){
			$('.location-tab').parent().addClass('active');
		}
		if($('.reference-tab').parent().hasClass('active')){
			$('.reference-tab').parent().removeClass('active');
		}		
		$(".pop-cont").show();
	});
	$(".reference").live('click', function(){
		...
		if(!$('.reference-tab').parent().hasClass('active')){
			$('.reference-tab').parent().addClass('active');
		}	
		if($('.location-tab').parent().hasClass('active')){
			$('.location-tab').parent().removeClass('active');
		}		
		$(".pop-cont").show();
	});
}
