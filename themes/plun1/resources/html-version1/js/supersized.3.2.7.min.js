        ...
        r.resizeNow = function () {
            return r.$el.each(function () {
                e("img", r.el).each(function () {
                    ...
                    //r.options.fit_landscape && e(this).css("width","100%");
					r.options.fit_portrait && e(this).css("height","100%");
					thisSlide.parents("li").hasClass("image-loading") && e(".image-loading").removeClass("image-loading");
                    //r.options.horizontal_center && e(this).css("left", (n - e(this).width()) / 2); //ngohai;
