...
/**
 * This is the model class for table "usr_friendship".
 *
 * The followings are the available columns in table 'usr_friendship':
 ...
 */
class usrFriendship extends CActiveRecord
{
	/**
	 ...
	 * @return usrFriendship the static model class
	 */
