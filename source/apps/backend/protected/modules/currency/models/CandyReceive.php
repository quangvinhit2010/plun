...
/**
 * This is the model class for table "cr_candy_receive".
 *
 * The followings are the available columns in table 'cr_candy_receive':
 * @property integer $id
 ...
 */
class CandyReceive extends CandyActiveRecord
{
	/**
	 ...
	 * @return CandyReceive the static model class
	 */
