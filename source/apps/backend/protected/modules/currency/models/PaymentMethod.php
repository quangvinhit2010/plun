...
/**
 * This is the model class for table "cr_payment_method".
 *
 * The followings are the available columns in table 'cr_payment_method':
 * @property integer $id
 * @property string $title
 * @property string $description
 * @property integer $status
 */
class PaymentMethod extends CandyActiveRecord
{
	/**
