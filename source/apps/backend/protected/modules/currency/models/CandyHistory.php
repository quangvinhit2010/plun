...
/**
 * This is the model class for table "cr_candy_history".
 *
 * The followings are the available columns in table 'cr_candy_history':
 * @property integer $id
 ...
 */
class CandyHistory extends CandyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('user_id, object_id, object_type, action_type, charge_id, status, created, updated', 'numerical', 'integerOnly'=>true),
			array('action_id', 'length', 'max'=>11),
			array('candy_amount, candy_current', 'length', 'max'=>20),
			array('description', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, object_id, object_type, action_id, action_type, candy_amount, candy_current, charge_id, description, status, created, updated', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CandyHistory the static model class
	 */
