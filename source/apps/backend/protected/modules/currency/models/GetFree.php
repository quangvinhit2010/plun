...
/**
 * This is the model class for table "cr_get_free".
 *
 * The followings are the available columns in table 'cr_get_free':
 * @property integer $id
 ...
 */
class GetFree extends CandyActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, amount, type, description', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GetFree the static model class
	 */
