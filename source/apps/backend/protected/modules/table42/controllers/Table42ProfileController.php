...
class Table42ProfileController extends PController
{
	/**
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Table42Profile']))
		{
			$model->attributes=$_POST['Table42Profile'];
	...
	{
		$dataProvider=new CActiveDataProvider('Table42Profile');
	...
	{
		$model=new Table42Profile('search');
	...
	{
		$model=Table42Profile::model()->findByPk($id);
		if($model===null)
