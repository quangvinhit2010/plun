...
class EFineUploader extends CWidget
{
	...
	public $css=null;
		...
		$assets = dirname(__FILE__).'/assets';
                ...
                if(file_exists(Yii::getPathOfAlias ( 'pathroot' ) . DS. $fJs)){
                ...
                if(file_exists(Yii::getPathOfAlias ( 'pathroot' ) . DS .$this->css)){
		...
		$config = CJavaScript::encode($config);
                Yii::app()->getClientScript()->registerScript("FineUploader_".$this->id, "var FineUploader_".$this->id." = new qq.FineUploader($config);",CClientScript::POS_END);
	}
