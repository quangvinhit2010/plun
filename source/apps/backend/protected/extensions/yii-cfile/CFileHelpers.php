...
/**
 * CFileHelpers is used to access CFile functionality from environments
 * without Yii Framework.
 *
 * Do not confuse with CFileHelpers from Yii distribution!
 *
 * Usage example:
 *
 *     $cf_file = CFileHelpers::get('files/test.txt');
 *
 */
class CFileHelpers extends CFile {
