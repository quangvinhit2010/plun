...
class EFtpComponent extends CApplicationComponent
{
	...
	{
	    $params = CParams::load ();
		$this->host = $params->params->ftp->host;
        $this->username = $params->params->ftp->username;
        $this->password = $params->params->ftp->password;
        $this->ssl = $params->params->ftp->ssl;
        $this->port = $params->params->ftp->port;
        $this->timeout = $params->params->ftp->timeout;
	}
