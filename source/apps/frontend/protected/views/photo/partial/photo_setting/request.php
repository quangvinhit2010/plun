			...
			<li class="item request-photo-<?php echo $user_photo_id; ?>">
				<div class="feed clearfix">
					...
					<div class="info info_photo_setting">
						<p><span class="username"><a href="<?php echo $photo['request_user_info']['url']; ?>"><?php echo $photo['request_user_info']['name']; ?></a></span> 
						...
						<ul class="list_avatar photo_request_<?php echo $key;?> view-request-photo-<?php echo $user_photo_id; ?>">
							<?php if(isset($photo['request_list'][0])): ?>
								<?php $is_more = 0;?>
								<?php foreach ($photo['request_list'] as  $group_photo) {?>
									...
									<?php if($group_photo['photo_user_id'] == Yii::app()->user->id) {?>
										<?php $is_more++;?>
			                			<?php if($is_more < 8) {?>
				                			<li class="list-request-photo-<?php echo $group_photo['id'];?>"><a href="javascript:void(0);" onclick="Photo.open_request_popup('request-photo-<?php echo $user_photo_id; ?>', this, 'view-request-photo-<?php echo $user_photo_id; ?>');"><?php echo $group_photo['thumbnail_html']; ?></a></li>
										<?php } else { ?>
											<li style="display: none;"class="list-request-photo-<?php echo $group_photo['id'];?>"><a href="javascript:void(0);" onclick="Photo.open_request_popup('request-photo-<?php echo $user_photo_id; ?>', this, 'view-request-photo-<?php echo $user_photo_id; ?>');"><?php echo $group_photo['thumbnail_html']; ?></a></li>
										<?php } ?>
			                		<?php } ?>	
			                	<?php } ?>
			                	<?php if($is_more > 8) {?>
