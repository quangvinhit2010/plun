									...
									<li id="hotbox-<?php echo $hotbox->id;?>" class="item hotbox-load hotbox-<?php echo $hotbox->getType();?> <?php echo $hotbox->getAuthorElement();?> <?php echo $hotbox->getFeature();?>">
										...
										<div class="cont">
											<div class="social">
												<ul>
													<li>
														<i class="ismall ismall-like"></i><span class="inline-text"><span class="txt-change-like"><?php echo Lang::t('hotbox', 'Like');?></span> (<span class="num-like-hotbox"><?php echo $hotbox->getLikeCount() ;?></span>)</span>
													</li>
													<li>
										...
										<div class="author">
											<?php if($hotbox->author->username == 'plunasia') { ?>
												<a class="ava" title="" href="javascript:void(0);">
													<?php echo $hotbox->author->getAvatar(true); ?>
												</a>
												<div class="info">
