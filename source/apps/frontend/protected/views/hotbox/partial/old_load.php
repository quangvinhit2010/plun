<?php if(isset($hotbox)) {?>
	...
	<div class="col-feed col-left">
		<div class="block news-feed hotbox_detail">
			<a href="javascript:Hotbox.close_detail(true);" class="btn-del-hotbox"></a>
			<div class="detail_hotbox">
				...
				<div class="content">
					<?php if($hotbox->type == Hotbox::PHOTO) {?>
					...
					<?php } else { ?>
						<?php if(isset($hotbox->images)) { ?>
							<?php foreach ($hotbox->images as $key => $image) {?>
								<p><a href="javascript:void(0);"><?php echo $image->getImageDetail(array('alt' => $image->id, 'border' => '', 'align' => 'absmiddle'));?></a></p>
							<?php } ?>
						<?php } ?>
					<?php } ?>
