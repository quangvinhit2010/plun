            	...
            	<ul>
                	<li class="icon_ps active main_st profile_settings">
                        ...
                        <ol style="display:block;" class="sub_main">
                            <li><a href="javascript:void(0);" onclick="avatarSettings(this);" link="<?php echo $this->user->createUrl('/settings/avatar'); ?>"><?php echo Lang::t('settings', 'Profile Photo'); ?></a></li>
                    ...
                    <li class="icon_as main_st account_settings">
                    	...
                    	<ol style="display:block;" class="sub_main">
                        	<li><a href="javascript:void(0);" onclick="languageSettings(this);" link="<?php echo $this->user->createUrl('/settings/languageSettings'); ?>"><?php echo Lang::t('settings', 'Languages & Change Units'); ?></a></li>
