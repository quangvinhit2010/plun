<form method="get" class="frm-quicksearch" id="frm-quicksearch" action="<?php echo Yii::app()->createUrl('//my/quicksearch');?>">
    <div class="navblock left w400 search_form">
        <label class="search_icon"></label>
        <input autocomplete="On" style="width: 235px;" id="quicksearch_suggestuser" name="q" type="text" onfocus="if(this.value==this.defaultValue) this.value=''" onblur="if(this.value=='') this.value=this.defaultValue" value="<?php echo !empty($q)    ?   $q:'Search'; ?>" class="quicksearch" />
                <?php 
                  ...
                  'options'=>array(
                    ...
                    'formatResult'=>'js:function(item) {
                          if(item.id == 0){
                            ...
                            return "<div class=\"search-suggestuser-item\"><a target=\"_blank\" href=\""+ item.url + "\"><img class=\"left\" width=\"40px\" height=\"40px\" src=\"" + item.ava + "\"/></a>" + 
