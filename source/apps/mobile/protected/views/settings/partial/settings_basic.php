		                            ...
		                            <td style="padding-left:0;">
		                             <div class="select_style w160">
										<?php
		                    	            ...
		                    	            echo CHtml::dropDownList('UsrProfileSettings[country_id]', $model->country_id, $list_country, array('onchange' => 'getStateRegister();', 'name' => 'txt-country','id' => 'UsrProfileSettings_country_id','class' => 're-country virtual_form', 'text' => 'country_register_text'));
		                    	        ?>
		                            ...
		                            <td class="rs-state"<?php echo $state_none; ?>>
										...
										<div class="select_style w160">
										  <?php
											...
											echo CHtml::dropDownList('UsrProfileSettings[state_id]',$model->state_id, $list_state, array('name' => 'txt-state', 'id' => 'UsrProfileSettings_state_id', 'onchange' => "getCityRegister();",'class' => 're-state virtual_form', 'text' => 'state_register_text','empty' => Lang::t('search', '--Any--'))); 
											?>
										  <span class="txt_select"><span class="state_register_text"><?php echo $list_state[$model->state_id]; ?></span></span> <span class="btn_combo_down"></span> </div>
										<?php endif; ?>
		                            </td>
		                          </tr>
		                          <tr>
                  ...
                  <tr>
                    ...
                    <td>
                    	<div class="select_style w160">
                            ...
                            <span class="txt_select"><span class="horoscope_text"><?php echo $horoscope_selected; ?></span></span> <span class="btn_combo_down"></span>
                        </div>
                    </td>
                  </tr>
                  <tr>
