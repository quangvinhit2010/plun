<?php if(sizeof($list_state) > 0): 
	...
	if(sizeof($top_state)){
		...
		$list_state_group	=	$list_state;
			...
			echo CHtml::dropDownList('state_id',0, $list_state_group, array('onchange' => 'getCityCheckIn();', 'id' => 'Checkin_state_id', 'class' => 'select-type-1 ci-state virtual_form', 'text' => 'state_checkin_text', 'empty' => Lang::t('search', '--Any--'))); 
	?>
