...
class Findhim extends CWidget {
    ...
    public function run() {
        ...
        $country_id	=	!empty($this->controller->usercurrent->profile_settings->country_id)	?	$this->controller->usercurrent->profile_settings->country_id	:	false;
        $measurement	=	!empty($this->controller->usercurrent->profile_settings->measurement)	?	$this->controller->usercurrent->profile_settings->measurement	:	false;
