...
$table42 = $pathroot . DS . 'source/apps/table42/protected';
...
Yii::setPathOfAlias ( 'table42', $table42 );
...
return array (
		...
		'theme' => 'table42',
		'runtimePath' => $table42 . DS . 'runtime',
		...
		'import' => array (
		        ...
		        'backend.modules.table42.models.*',
				'application.helpers.*',
				'application.models.*',
		...
		'components' => CMap::mergeArray ( array (
				'user' => array (
						'allowAutoLogin' => true,
						'class' => 'table42.components.YumWebUser' 
				),
				'urlManager' => array (
						'showScriptName' => false,
						'urlFormat' => 'path',
						'rules' => CMap::mergeArray ( array (), require (dirname ( __FILE__ ) . '/_partials/urls_table42.php') ) 
				),
				'errorHandler' => array (
...
// 						        ),
				...
				'assetManager' => array (
						'basePath' => dirname ( __FILE__ ) . '/../source/apps/table42/assets/',
						'baseUrl' => '/source/apps/table42/assets/' 
				),
				'themeManager' => array (
		...
		), require (dirname ( __FILE__ ) . '/_partials/params_table42.php') ) 
);
